...
export const Automobiles: Record<string, CJCategory[]> = {
  ...
  'Car Electronics': [
    ...
    { categoryId: '5F6BBD36-AFDE-4433-81D1-8684781E04DE', name: 'Car Mirror Video' },
    { categoryId: 'A3E67E41-8A5C-449F-8C22-739889760AAD', name: 'Car Radios' },
    { categoryId: 'B39B6F95-9C89-4D6C-9E98-1633DA6A51CF', name: 'GPS Trackers' },
    { categoryId: 'B43C754E-838C-4028-99E7-D3D0E029C68C', name: 'Car Multimedia Player' },
    { categoryId: 'BCC009E7-B5FF-4E4B-8D1D-7DE5B5DBFAE0', name: 'Alarm Systems & Security' },
  ...
  'Motorcycle Accessories & Parts': [
    ...
    { categoryId: '4FB5AA23-AA52-4928-A653-616ED3347074', name: 'Motorcycle Seat Covers' },
    { categoryId: '628E44C8-73BF-4D4C-87C9-0B4F9A60D0C3', name: 'Other Motorcycle Accessories' },
    { categoryId: '683FC820-3B12-4F92-A250-FF213D8D3899', name: 'Helmet Headset' },
  ...
  'Auto Replacement Parts': [
    ...
    { categoryId: 'C8B7A95E-0E98-41F8-892B-35B5679713A6', name: 'Automobiles Sensors' },
    { categoryId: 'CAE924E7-EB56-4299-A5B0-8DB86C9ECB52', name: 'Exterior Parts' },
    { categoryId: 'CB255FA6-9B4C-4542-82CC-F774DE8F8C68', name: 'Other Replacement Parts' },
    { categoryId: 'E987126C-FF3D-4BCF-B496-40990D39D2F8', name: 'Car Lights' },
    { categoryId: 'FF672D98-F632-4C18-ABA3-E86C9C8951FE', name: 'Windscreen Wipers & Windows' },
  ],
};
